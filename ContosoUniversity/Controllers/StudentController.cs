...
namespace ContosoUniversity.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            ViewBag.NameSortParm = string.IsNullOrEmpty(sortOrder) ? "name_disc" : "";
            ViewBag.DateSortParm = sortOrder == "Date" ? "date_disc" : "Date";
        ...
        public ActionResult Create([Bind(Include = "LastName,FirstMidName,EnrollmentDate,Age")] Student student)
        {
            ...
            {
                ModelState.AddModelError("", "Unable to save changes. Try again, and if the proble persistens see your system administrator.");
            }
            return View(student);
        }
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            if (TryUpdateModel(studentToUpdate, "", new string[] { "LastName", "FirstMidName", "EnrollmentDate, Age" })) 
            {
                try
                {
                    db.SaveChanges();
